        ...
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], a = 1; a < arguments.length; a += 1) {
            ...
            if (null != i)
                for (var s = Object.keys(Object(i)).filter((function(e) {
                    ...
                    void 0 !== o && o.enumerable && (S(e[l]) && S(i[l]) ? i[l].__swiper__ ? e[l] = i[l] : C(e[l], i[l]) : !S(e[l]) && S(i[l]) ? (e[l] = {},
      ...
      , R = {
        ...
        slide: {
            slideTo: function(e, t, a, i) {
                ...
                (c || l.initialSlide || 0) === (p || 0) && a && r.emit("beforeSlideChangeStart");
                var m, g = -o[f];
        ...
        events: {
            attachEvents: function() {
                ...
                a.updateOnWindowResize ? e.on(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N, !0) : e.on("observerUpdate", N, !0)
            },
            detachEvents: function() {
                ...
                e.off(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N)
            }
        },
        breakpoints: {
        ...
        update: function() {
            ...
            if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                ...
                "progressbar" === a.type) {
                    ...
                    r.find("." + a.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + T + ") scaleY(" + S + ")").transition(e.params.speed)
                }
